  ...
  return (
    <div className="text-center">        
      <div class="flex items-center justify-center w-full">
        <label
          for="dropzone-file"
          class="flex flex-col items-center justify-center w-full h-64 border-2 border-blue-300
     border-dashed rounded-lg cursor-pointer bg-blue-50 dark:hover:bg-bray-800
     ...
     dark:hover:border-gray-500 dark:hover:bg-gray-600"
      ...
      {progress > 0 ? <ProgressBar progress={progress}/>: (<button disabled={!file}
